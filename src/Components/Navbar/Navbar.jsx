...
function Navbar() {
  ...
  const adminoruser = user?.user?.email 

  //admin hai ya fir user
          ...
          <div className="fixed inset-0 z-40 flex">
            ...
            >
              ...
              {user &&   <div className="flow-root">
                ...
                {adminoruser== "rehantthapa@gmail.com" ? <div className="flow-root">
                  ...
                  <div className="flow-root">
                    <Link to={'/'} className="-m-2 block p-2 font-medium text-gray-900 cursor-pointer">
                      <img
                        ...
                        src="https://i.pinimg.com/236x/15/51/f2/1551f2a232f80cfe77eb7e8c28859d1f.jpg"
                        alt="Rehant_Thapa" />                                        </Link>
                  </div>
                </div>
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                 ...
                 {user && <Link to={'/order'} className="text-sm font-medium text-gray-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                  ...
                  {adminoruser=="rehantthapa@gmail.com"?<Link to={'/dashboard'} className="text-sm font-medium text-gray-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                    Admin
                  </Link>:""}
                ...
                <div className="hidden lg:ml-8 lg:flex">
                  <a href="#" className="flex items-center text-gray-700 ">
                    <img
                      className="inline-block w-5 h-18 rounded-full"
                      src="https://i.pinimg.com/236x/15/51/f2/1551f2a232f80cfe77eb7e8c28859d1f.jpg"
                      alt="Rehant_Thapa" />
                  </a>
                </div>
